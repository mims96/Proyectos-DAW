...
public class EmpresaDaoImplList implements EmpresaDao{
	...
	// Creamos un constructor con el nombre y creamos el ArrayList plantilla y
	...
	// a que el empleado ya existe y por lo tanto no se ha agregado.
	// Si no esta lo agreamos con el add del ArrayList.
	@Override
	...
	// Con este metodo creamos un empleado virutal donde le pasamos la idEmpleado que estamos buscando. En el caso de que no coincida
	// index nos devuelve -1, por lo tanto sera nulo. Si concide sacaremos el empleado de la plantilla.  
	@Override
	...
	// para ir pasando por todos los empleados y sumamos el salario y la comision utilizando el metodo salarioBruto() que tenemos
	...
	// Creamos un ArrayList auxiliar donde vamos a añadir el empleado cuando lo encontremos y con un for vamos a ir buscando por todos
	...
	// Creamos una ArrayList auxiliar donde vamos a añadir el empleado cuando lo encontremos, y con un for vamos a ir buscando por todos
